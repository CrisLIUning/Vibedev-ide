...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            // VIBEDEV: app menu name + About/Hide/Quit labels rebranded (upstream "VibeDev").
            name: "VibeDev".into(),
            disabled: false,
            items: vec![
                MenuItem::action("关于 VibeDev", zed_actions::About),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("上移一行", editor::actions::MoveLineUp),
                MenuItem::action("下移一行", editor::actions::MoveLineDown),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("前往文件...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("前往项目中的符号", project_symbols::Toggle),
                MenuItem::action(
                    "前往编辑器中的符号...",
                    zed_actions::outline::ToggleOutline,
                ),
                MenuItem::action("前往行/列...", editor::actions::ToggleGoToLine),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Report an Issue...", zed_actions::feedback::EmailZed),
                MenuItem::separator(),
                MenuItem::action(
                    "文档",
                    super::OpenBrowser {
                ...
                // VIBEDEV: relabel repo link; drop "VibeDev Twitter" + "加入团队"
                // (Zed's own socials / hiring page).
                MenuItem::action("VibeDev Repository", feedback::OpenZedRepo),
            ],
        },
    ]
}
