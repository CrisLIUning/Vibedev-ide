                    ...
                    return div().child(
                        IconButton::new("zed-predict-pending-button", ep_icon)
                            ...
                            .tooltip(move |_window, cx| {
                                Tooltip::with_meta("Edit Prediction", None, tooltip_meta, cx)
                            })
                            .on_click(cx.listener(move |_, _, window, cx| {
                                telemetry::event!(
                                    "Pending ToS Clicked",
...
impl EditPredictionButton {
    ...
    fn build_copilot_context_menu(
        ...
        ContextMenu::build(window, cx, |menu, window, cx| {
            ...
            // VIBEDEV: removed Copilot "Sign Out" — we no longer surface
        ...
        ContextMenu::build(window, cx, |mut menu, window, cx| {
            ...
            if needs_sign_in {
                menu = menu
                    ...
                    // VIBEDEV: removed "Learn More" link — it pointed to
