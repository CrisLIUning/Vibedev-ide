...
const HARDCODED_RULES_DESCRIPTION: &str =
    "当在 `$HOME`、`~`、`.`、`..` 或 `/` 上运行时,`rm -rf` 命令始终会被阻止";
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions only apply to the VibeDev native agent and don’t extend to external agents connected through the Agent Client Protocol (ACP).";
...
const TOOLS: &[ToolInfo] = &[
    ToolInfo {
        ...
        regex_explanation: "模式与输入中的每个命令进行匹配。以 &&, ||, ; 或管道连接的命令会被拆分并单独检查。",
    },
    ToolInfo {
        id: "edit_file",
        name: "编辑文件",
        description: "文件编辑操作",
        regex_explanation: "模式与正在编辑的文件路径进行匹配。",
    },
    ToolInfo {
        id: "write_file",
        name: "写入文件",
        description: "文件创建和覆盖操作",
        regex_explanation: "模式将与正在写入的文件路径进行匹配。",
    },
    ToolInfo {
        id: "delete_path",
        name: "删除路径",
        description: "文件和目录删除",
        regex_explanation: "模式与正在删除的路径进行匹配。",
    },
    ToolInfo {
        id: "copy_path",
        name: "复制路径",
        description: "文件和目录复制",
        regex_explanation: "模式将分别与源路径和目标路径进行匹配。在下方输入任一路径进行测试。",
    },
    ToolInfo {
        id: "move_path",
        name: "移动路径",
    ...
    ToolInfo {
        ...
        name: "创建目录",
        description: "目录创建",
        regex_explanation: "模式与正在创建的目录路径进行匹配。",
    },
    ToolInfo {
        id: "fetch",
        name: "获取",
        description: "对 URL 的 HTTP 请求",
        regex_explanation: "模式与正在获取的 URL 进行匹配。",
    },
    ToolInfo {
        id: "search_web",
        name: "Web Search",
        description: "网页搜索查询",
        regex_explanation: "模式与搜索查询进行匹配。",
    },
    ToolInfo {
        id: "skill",
        name: "技能",
        description: "加载智能体技能指令",
        regex_explanation: "模式将与技能 SKILL.md 文件的绝对路径进行匹配。",
    },
];
        ...
        .child(
            v_flex()
                ...
                .child(render_rule_section(
                    tool.id,
                    "始终允许",
                    "如果任何正则表达式匹配,操作将被批准——除非匹配了始终确认或始终拒绝规则。",
                ...
                .child(render_rule_section(
                    tool.id,
                    "始终确认",
                    "如果任何正则表达式匹配,将显示确认提示,除非“始终拒绝”的正则表达式匹配。",
