...
fn editor_page() -> SettingsPage {
    ...
    fn hover_popover_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "git.inline_blame.enabled",
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "git.inline_blame.delay_ms",
    ...
    fn toolbar_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "terminal.toolbar.breadcrumbs",
...
fn languages_and_tools_page(cx: &App) -> SettingsPage {
    ...
    fn inline_diagnostics_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "git.inline_blame.padding",
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "git.inline_blame.min_column",
    ...
    fn title_bar_section() -> [SettingsPageItem; 10] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Branch Name"),
                    pick: |settings_content| {
                        settings_content
                            .title_bar
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Project Items"),
                    pick: |settings_content| {
                        settings_content
                            .title_bar
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Onboarding Banner"),
                    pick: |settings_content| {
                        settings_content
                            .title_bar
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show User Picture"),
                    pick: |settings_content| {
                        settings_content
                            .title_bar
                            .as_ref()?
    ...
    fn tab_bar_section() -> [SettingsPageItem; 9] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Git Status In Tabs"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show File Icons In Tabs"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Tab Close Position"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Navigation History Buttons"),
                    pick: |settings_content| {
                        settings_content
                            .tab_bar
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Tab Bar Buttons"),
                    pick: |settings_content| {
                        settings_content
                            .tab_bar
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Pinned Tabs Layout"),
                    pick: |settings_content| {
                        settings_content
                            .tab_bar
                            .as_ref()?
    ...
    fn tab_settings_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Activate On Close"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Tab Show Diagnostics"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Close Button"),
                    pick: |settings_content| {
    ...
    fn preview_tabs_section() -> [SettingsPageItem; 8] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Preview Tabs Enabled"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Preview From Project Panel"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Preview From File Finder"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Preview From Multibuffer"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Preview Multibuffer From Code Navigation"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Preview File From Code Navigation"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Enable Keep Preview On Code Navigation"),
                    pick: |settings_content| {
                        settings_content
                            .preview_tabs
                            .as_ref()?
    ...
    fn layout_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Centered Layout Left Padding"),
                    pick: |settings_content| {
                        settings_content
                            .workspace
                            .centered_layout
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Centered Layout Right Padding"),
                    pick: |settings_content| {
                        settings_content
                            .workspace
                            .centered_layout
    ...
    fn pane_modifiers_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Inactive Opacity"),
                    pick: |settings_content| {
                        settings_content
                            .workspace
    ...
    fn project_panel_section() -> [SettingsPageItem; 29] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Project Panel Dock"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Project Panel Default Width"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Auto Reveal Entries"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Auto Fold Directories"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Bold Folder Labels"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Diagnostics"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Indent Guides"),
                    pick: |settings_content| {
                        settings_content
                            .project_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "project_panel.drag_and_drop",
    ...
    fn outline_panel_section() -> [SettingsPageItem; 11] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Outline Panel Button"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Outline Panel Dock"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Outline Panel Default Width"),
                    pick: |settings_content| {
                        settings_content
                            .outline_panel
                            .as_ref()?
    ...
    fn git_panel_section() -> [SettingsPageItem; 15] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Git Panel Button"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Git Panel Default Width"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Git Panel Status Style"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Fallback Branch Name"),
                    pick: |settings_content| {
                        settings_content
                            .git_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Collapse Untracked Diff"),
                    pick: |settings_content| {
                        settings_content
                            .git_panel
                            .as_ref()?
    ...
    fn debugger_panel_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Debugger Panel Dock"),
    ...
    fn collaboration_panel_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Collaboration Panel Button"),
                    pick: |settings_content| {
                        settings_content
                            .collaboration_panel
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "collaboration_panel.dock",
    ...
    fn agent_panel_section() -> [SettingsPageItem; 7] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Agent Panel Button"),
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Agent Panel Default Width"),
                    pick: |settings_content| {
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Agent Panel Default Height"),
                    pick: |settings_content| {
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Stepping Granularity"),
                    pick: |settings_content| {
                        settings_content
                            .debugger
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Save Breakpoints"),
                    pick: |settings_content| {
                        settings_content
                            .debugger
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Log DAP Communications"),
                    pick: |settings_content| {
                        settings_content
                            .debugger
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Format DAP Log Messages"),
                    pick: |settings_content| {
                        settings_content
                            .debugger
                            .as_ref()?
        ...
        [
                ...
                SettingsPageItem::DynamicItem(DynamicItem {
                    discriminant: SettingItem {
                        ...
                        field: Box::new(SettingField {
                            json_path: Some("Working Directory"),
                            pick: |settings_content| {
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    field: Box::new(
                        SettingField {
                            json_path: Some("Environment Variables"),
                ...
                SettingsPageItem::SettingItem(SettingItem {
                    ...
                    field: Box::new(
                        SettingField {
                            json_path: Some("Detect Virtual Environment"),
    ...
    fn display_settings_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Alternate Scroll"),
                    pick: |settings_content| {
                        settings_content
                            .terminal
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Minimum Contrast"),
                    pick: |settings_content| {
                        settings_content
                            .terminal
                            .as_ref()?
    ...
    fn advanced_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Max Scroll History Lines"),
                    pick: |settings_content| {
                        settings_content
                            .terminal
                            .as_ref()?
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Scroll Multiplier"),
                    pick: |settings_content| {
                        settings_content
                            .terminal
                            .as_ref()?
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    field: Box::new(SettingField::<bool> {
                        json_path: Some("Disable Git Integration"),
                        pick: |settings_content| {
                            settings_content
                                .git
                                .as_ref()?
                ...
                fields: vec![
                    ...
                    vec![
                        SettingItem {
                            ...
                            field: Box::new(SettingField::<bool> {
                                json_path: Some("Enable Git Status"),
                                pick: |settings_content| {
                                    settings_content
                                        .git
                                        .as_ref()?
                        ...
                        SettingItem {
                            ...
                            field: Box::new(SettingField::<bool> {
                                json_path: Some("Enable Git Diff"),
                                pick: |settings_content| {
                                    settings_content
                                        .git
                                        .as_ref()?
    ...
    fn inline_git_blame_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Commit Summary"),
                    pick: |settings_content| {
                        settings_content
                            .git
                            .as_ref()?
    ...
    fn branch_picker_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                field: Box::new(SettingField {
                    json_path: Some("Show Author Name"),
                    pick: |settings_content| {
                        settings_content
                            .git
                            .as_ref()?
...
fn non_editor_language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn debugger_section() -> [SettingsPageItem; 2] {
        [
            SettingsPageItem::SectionHeader("Debugger"),
            SettingsPageItem::SettingItem(SettingItem {
                title: "Debugger",
                description: "Preferred debuggers for this language.",
                field: Box::new(
